	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220722/0885076d7f30408eacce61b42c646c1f.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"20px 30px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","margin":"0","borderRadius":"10px","top":"0","background":"#fff","width":"500px","position":"absolute","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"padding":"20px","margin":"0 0 10px 0","color":"rgba(0, 0, 0, 1)","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","fontWeight":"600","height":"auto"}' class="title">基于springboot的同城家教系统的设计与实现.注册</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='jiajiaolaoshi'">
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='jiajiaolaoshi'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">教师邮箱</div>
		...
		login() {
            ...
            if(this.ruleForm.touxiang!=null) {
                this.ruleForm.touxiang = this.ruleForm.touxiang.replace(new RegExp(this.$base.url,"g"),"");
					...
					if((!this.ruleForm.mima) && `jiajiaolaoshi` == this.tableName){
						this.$message.error(`密码不能为空`);
						return
					}
					...
					if((this.ruleForm.mima!=this.ruleForm.mima2) && `jiajiaolaoshi` == this.tableName){
						this.$message.error(`两次密码输入不一致`);
						return
					}
            ...
            if(this.ruleForm.touxiang!=null) {
                this.ruleForm.touxiang = this.ruleForm.touxiang.replace(new RegExp(this.$base.url,"g"),"");
					...
					if((!this.ruleForm.xueli) && `jiajiaolaoshi` == this.tableName){
					...
					if(`jiajiaolaoshi` == this.tableName && this.ruleForm.jiaoshiyouxiang&&(!this.$validate.isEmail(this.ruleForm.jiaoshiyouxiang))){
					...
					if(`jiajiaolaoshi` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
