<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","backgroundImage":"url(http://codegen.caihongy.cn/20221024/23b37078fa41495b866fda764fd3ea28.png)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px","borderRadius":"10px","left":"565px","background":"#fff","width":"750px","position":"absolute","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"30px 0 20px 0","lineHeight":"44px","fontSize":"36px","color":"#000","textAlign":"center"}'>基于springboot的同城家教系统的设计与实现.注册</p></div>
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='yonghu'" prop="jiatingzhuzhi">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiajiaolaoshi'" prop="jiaoshigonghao">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiajiaolaoshi'" prop="mima">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiajiaolaoshi'" prop="mima">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiajiaolaoshi'" prop="jiaoshixingming">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiajiaolaoshi'" prop="touxiang">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>头像：</div>
                <file-upload
					tip="点击上传头像"
					action="file/upload"
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiajiaolaoshi'" prop="xingbie">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>性别：</div>
                <el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
                  <el-option
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiajiaolaoshi'" prop="xueli">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiajiaolaoshi'" prop="zhuanye">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiajiaolaoshi'" prop="jiaoshiyouxiang">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>教师邮箱：</div>
				<el-input v-model="registerForm.jiaoshiyouxiang"  placeholder="请输入教师邮箱" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiajiaolaoshi'" prop="lianxidianhua">
...
export default {
    ...
    created() {
      ...
      if ('jiajiaolaoshi' == this.tableName) {
        this.rules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }];
      }
      ...
      if ('jiajiaolaoshi' == this.tableName) {
        this.rules.jiaoshiyouxiang = [{ required: true, validator: this.$validate.isEmail, trigger: 'blur' }];
      }
      if ('jiajiaolaoshi' == this.tableName) {
          ...
          if (valid) {
            var url=this.tableName+"/register";
              ...
              if(`yonghu` == this.tableName && this.registerForm.mima.length>10){
               ...
               if(`jiajiaolaoshi` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
                this.$message.error(`两次密码输入不一致`);
                return
               }
