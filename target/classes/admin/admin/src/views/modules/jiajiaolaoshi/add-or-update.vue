	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="学历" prop="xueli">
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="教师邮箱" prop="jiaoshiyouxiang">
					<el-input v-model="ruleForm.jiaoshiyouxiang" placeholder="教师邮箱" clearable  :readonly="ro.jiaoshiyouxiang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="教师邮箱" prop="jiaoshiyouxiang">
					<el-input v-model="ruleForm.jiaoshiyouxiang" placeholder="教师邮箱" readonly></el-input>
				</el-form-item>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiajiaolaoshi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiajiaolaoshiCrossAddOrUpdateFlag = false;
						 this.parent.search();
