	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="课程类别" prop="kechengleibie">
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="课程类别" prop="kechengleibie">
					<el-input v-model="ruleForm.kechengleibie"
						placeholder="课程类别" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="上课时间" prop="shangkeshijian">
					<el-input v-model="ruleForm.shangkeshijian" placeholder="上课时间" clearable  :readonly="ro.shangkeshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="上课时间" prop="shangkeshijian">
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="工作状态" prop="gongzuozhuangtai">
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="工作状态" prop="gongzuozhuangtai">
					<el-input v-model="ruleForm.gongzuozhuangtai"
						placeholder="工作状态" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'" label="教师工号" prop="jiaoshigonghao">
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jiaoshigonghao" label="教师工号" prop="jiaoshigonghao">
				...
				<el-form-item :style='{"width":"45%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="性别" prop="xingbie">
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.gongzuozhuangtaiOptions = "已预约,可预约".split(',')
            this.$http({
				url: `option/jiajiaolaoshi/jiaoshigonghao`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
			...
			jiaoshigonghaoChange () {
				this.$http({
					url: `follow/jiajiaolaoshi/jiaoshigonghao?columnValue=`+ this.ruleForm.jiaoshigonghao,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
						...
						if(data.data.xueli){
							this.ruleForm.xueli = data.data.xueli
						}
